        ...
        if(user) {
          ...
          if(json.merchant) {
            ...
            access.merchant = [
              id : merchant.id,
              name : merchant.name,
              endpoint : createLink(controller : 'merchants', params : [id : merchant.id], absolute : true) as String
            ]
            if(json.customer) {
              ...
              access.customer = [
                id : customer.id,
                name : customer.name,
                endpoint : createLink(controller : 'customers', params : [merchant : merchant.id, id : customer.id], absolute : true) as String
              ]
            }
          } else {
